        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <a href="/store-project/customer/profile.php" class="btn btn-outline-secondary rounded-pill px-4">
                ...
                <div class="card border-0 shadow-sm rounded-3 p-4 p-md-5">
                    <form action="" method="POST">
                        ...
                        <div class="d-flex justify-content-end gap-2 pt-2">
                            <a href="/store-project/customer/profile.php" class="btn btn-light rounded-pill px-4">Cancel</a>
